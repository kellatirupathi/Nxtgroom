...
export const MEN_ATTIRE_CHECKS = [
  ...
  { code: "M_SHIRT_CONDITION", name: "Shirt Condition", rule: "Covers cleanliness, stains, tears and heavy wrinkling or an obviously unpressed shirt, judged together. Look at the placket, the collar points, the sleeve length and the shoulder line: a pressed shirt shows flat cloth and a deliberate sleeve line there, while an unpressed one shows branching wrinkles across the body and upper sleeve that hold their shape. A few sitting creases at the lap or the inside of the elbow are the day's wear and not a failing. FAIL a shirt whose front or sleeves are broadly crushed, or one carrying a visible stain, tear or soiled collar or cuff. State in the observation which of cleanliness and pressing you are reporting on and where you saw it, since one can be met while the other is not." },
  ...
  { code: "M_TROUSERS_FIT_CONDITION", name: "Trousers Fit & Condition", rule: "Covers fit, visible condition, tears or fraying, heavy creasing and hem length together. Read pressing from the front of the thigh and the line down the leg: pressed trousers fall in a clean vertical line, while unpressed ones crush horizontally across the lap, the seat and behind the knee. The break at the shoe and any fraying at the hem belong here too. Ordinary creasing from sitting is not a failing; a leg broadly rumpled along its length is. Name the region your evidence came from in the observation." },
...
export const KURTI_ATTIRE_CHECKS = [
  ...
  { code: "W_KURTI_CONDITION", name: "Kurti Condition", rule: "Covers cleanliness, stains, tears, pilling, fading and heavy creasing together. Read pressing from the front panel, the placket or button line and the sleeves: pressed cloth lies flat there, while unpressed cloth shows branching wrinkles across the chest and upper sleeve that hold their shape. Pilling and fading show best at the cuffs, the shoulders and any seam. Creases picked up from sitting are the day's wear and not a failing. Name where your evidence was seen in the observation, and report cleanliness and pressing separately, since one can be met while the other is not." },
  {
    code: "W_BOTTOM_WEAR",
    name: "Bottom Wear",
