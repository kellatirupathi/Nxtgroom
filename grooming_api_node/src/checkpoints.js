...
export const MEN_ATTIRE_CHECKS = [
  ...
  { code: "M_SHIRT_COLLAR_TUCK", name: "Shirt Collar / Tuck", rule: "Covers collar presentation, no more than one button open, and tucking. The shirt must be visibly tucked at the waist. PASS only when the collar, buttons and tucked waist can all be assessed and comply. FAIL when the shirt is visibly untucked, or when the submitted photograph does not show the waist/tuck area well enough to verify this required check; state that the tuck is not shown and recommend a clearer full-body photograph. Do not return N/A merely because the waist is cropped, distant, blurred or occluded." },
